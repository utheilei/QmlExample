...
//    foreach (QString header, headers)
    ...
    item->setIcon("qrc:/icon/controlcenter_24px.svg");
    TreeItem *chidItem = new TreeItem(data, item);
    chidItem->setIcon("qrc:/icon/controlcenter_24px.svg");
    TreeItem *thirdChidItem = new TreeItem(data, chidItem);
    thirdChidItem->setIcon("qrc:/icon/controlcenter_24px.svg");
    TreeItem *secendChidItem = new TreeItem(secendData, item);
    secendChidItem->setIcon("qrc:/icon/controlcenter_24px.svg");
...
QVariant TreeModel::item(const QModelIndex &index, int role) const
{
    TreeItem *item = getItem(index);
