#ifndef TABLEMODELTEMPLATE_H
#define TABLEMODELTEMPLATE_H
...
template <class T>
class TableModelTemplate : public QAbstractItemModel
{
public:
    explicit TableModelTemplate(QObject *parent = Q_NULLPTR) : QAbstractItemModel(parent) {}
    ~TableModelTemplate() Q_DECL_OVERRIDE {}
